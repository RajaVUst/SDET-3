...
public final class ExtentManager {
    ...
    public static void info(String message) {
        logToCurrentTest(test -> test.info(message));
    }

    public static void pass(String message) {
        logToCurrentTest(test -> test.pass(message));
    }

    public static void fail(String message) {
        logToCurrentTest(test -> test.fail(message));
    }

    private static void logToCurrentTest(TestAction action) {
